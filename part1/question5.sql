...
((SELECT dog_id FROM Dogs WHERE name = 'Bella'), '2025-06-10 08:00:00', 20, 'Lakesview', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'Maxine'), '2025-06-10 08:00:00', 20, 'Lakesview', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'Bellarina'), '2025-06-10 08:00:00', 20, 'Lakesview', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'Basil'), '2025-06-10 08:00:00', 20, 'Lakesview', 'open');
